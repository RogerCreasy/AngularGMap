 ...
 *
 * Controllers for Interactive Golf Map app
 */

var golfControllers = angular.module('golfControllers', ['ngSanitize']);

    golfControllers.controller('MapCtrl', function ($scope, $http) {
